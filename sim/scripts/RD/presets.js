...
presets["default"] = {
  // When true (default for the browser app), picking ADER3 / ADER4 in the
  // timestepping dropdown silently runs the midpoint method instead — the
  // visual is FD-clean (no element-boundary structure). Set to false from
  // the URL (?aderVisualMode=false) to run the actual ADER-DG pipeline,
  // which is what the dissertation's GLSL convergence verification needs.
  aderVisualMode: true,
  automataMode: false,
  activeViewInd: 0,
